...
- Tests set `PAPERCLIP_AGENT_IDENTITIES_CREDENTIALS` to temporary files; production default is `/paperclip/.paperclip/agent-identities/credentials.json`, with legacy env/path fallback only when the renamed default is absent.
