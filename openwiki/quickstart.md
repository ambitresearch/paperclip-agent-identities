...
2. `/src/manifest.ts` declares plugin ID `ambitresearch.paperclip-agent-identities`, version `0.2.6`, required capabilities, eight tools, and two UI slots.
